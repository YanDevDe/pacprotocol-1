...
enum LLMQType : uint8_t
{
    ...
    // for testing only
    LLMQ_5_60 = 100, // 3 members, 2 (66%) threshold, one per hour. Params might differ when -llmqtestparams is used
