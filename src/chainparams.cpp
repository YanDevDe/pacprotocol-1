...
public:
    CMainParams() {
        ...
        consensus.DIP0003EnforcementHeight = 362299;
        consensus.DIP0003EnforcementHash = uint256();
        consensus.DIP0008Height = 366000;
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nTimeout = std::numeric_limits<int>::max();

        // Deployment of BIP68, BIP112, and BIP113.
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].bit = 0;
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nStartTime = 1573325000;
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nTimeout = std::numeric_limits<int>::max();

        // Deployment of DIP0001
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].bit = 1;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].nStartTime = 1573325000;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].nTimeout = std::numeric_limits<int>::max();
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_BIP147].nTimeout = std::numeric_limits<int>::max();
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0003].nThresholdStart = 1000;
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0008].nThresholdStart = 1500;
        ...
        consensus.defaultAssumeValid = uint256S("0x0945cebf5bc70f462c29fba09d45fc8ce7a494379535291ca1f55b6fd82f5d61"); // 600000
        ...
        checkpointData = {{
            ...
            {  450000,  uint256S("0xaa0f9f38148a188d254ad50cce9e1d14a2f910fca9ae74e21eba481698f1401e")},
            {  500000,  uint256S("0xc635d739b101776a1c426caaa2d8611cbe9b9b84dcc6329eeb621cbaa192bea3")},
            {  550000,  uint256S("0xbd9e1ac55bda8039f7c328fa32b2a90dec417f8805cd4ff4e12044e9293bc454")},
            {  600000,  uint256S("0x0945cebf5bc70f462c29fba09d45fc8ce7a494379535291ca1f55b6fd82f5d61")},
        }};
...
public:
    CTestNetParams() {
        ...
        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.fPowNoRetargeting = false;
        consensus.nPowKGWHeight = consensus.BIP34Height;
        consensus.nPowDGWHeight = consensus.BIP34Height;
        consensus.nRuleChangeActivationThreshold = 1916; // 95% of 2016
        consensus.nMinerConfirmationWindow = 2016; // nPowTargetTimespan / nPowTargetSpacing
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].bit = 28;
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nStartTime = 1573325000;
        ...
        consensus.nPosTargetTimespan = consensus.nPowTargetTimespan;
        consensus.nPosTargetSpacing = consensus.nPowTargetSpacing;
        consensus.nMinimumStakeValue = 50 * COIN;
        consensus.nMasternodeCollateral = 500000 * COIN;
...
public:
    CDevNetParams(bool fHelpOnly = false) {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // pacprotocol: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // pacprotocol: 2.5 minutes
