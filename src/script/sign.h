...
class HardwareSigner : public BaseSignatureCreator {
...
public:
    HardwareSigner(const CMutableTransaction* txToIn, unsigned int nInIn, const CAmount& amountIn, int nHashTypeIn = SIGHASH_ALL);
